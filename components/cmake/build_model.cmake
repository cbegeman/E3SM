function(build_model COMP_CLASS COMP_NAME)
  ...
  if (COMP_NAME STREQUAL "cpl")
    ...
    #  #find_library(sr_lib smartredis-fortran
    #  #       PATHS /home/ac.cbegeman/soft/smartredis/0.3.0/install/lib
    #  #       NO_DEFAULT_PATH REQUIRED)
    #  #target_link_libraries(${TARGET_NAME} PRIVATE ${sr_lib})
    ...
    #  #endif()
    #  set(SMARTREDIS_LIB_DIR "${SMARTREDIS_PATH}/lib")
    #  message(STATUS "SMARTREDIS_LIB_DIR = ${SMARTREDIS_LIB_DIR}")
    #  target_link_libraries(${TARGET_NAME} "-L${SMARTREDIS_LIB_DIR}")
    #  target_link_libraries(${TARGET_NAME} "-lhiredis")
    #  target_link_libraries(${TARGET_NAME} "-lredis++")
    #  target_link_libraries(${TARGET_NAME} "-lsmartredis-fortran")
    #endif()
  endif()
